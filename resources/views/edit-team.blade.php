        ...
        <div class="panel">
            <div class="create-team-form text-center">
                <form action="/update-team" method="post">
                    {{ csrf_field() }}
                    <h4>Updating team {{$team->name}}</h4>
                    <div class="form-group">
                        <input type="text" name="teamname" placeholder="Team Name" value="{{$team->name}}" />
                    </div>
                    <div class="form-group">
                        <input type="text" name="joinpw" placeholder="Password to join (for your teammates)" value="{{$team->join_password}}" />
                    </div>
                    <div class="form-group">
                        {{--<a href="#" id="uploader_old" class="change change-user-photo">Update</a>--}}
                        <input type="text" class="logoplaceholder" name="logo" placeholder="Team Logo (select a file)" id="uploader" value="{{$team->logo}}" />
