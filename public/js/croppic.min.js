            ...
            that.form.find('input[type="file"]').change(function(){
                ...
                $.ajax({
                    ...
                    if(response.status=='error'){
                        that.obj.append('<p style="width:100%; height:100%; text-align:center; line-height:'+that.objH+'px; background-color: #000; color: #F00">'+response.message+'</p>');
...
//            var cropControlRotateRight =     '<i class="cropControlRotateRight"></i>';
        ...
        crop:function(){
            ...
            $.ajax({
                ...
                if(response.status=='error'){
                    that.obj.append('<p style="width:100%; height:100%; background-color: #000; color: #F00">'+response.message+'</p>">');
                    //console.log(response.message);
                    alert('Error: ' + response.message);
                }
